...
World`);
    ...
    describe('switcher - getHighVariant', () => {
        describe('Claude models', () => {
            ...
            it('should return high variant for claude-opus-4-5-20251101', () => {
                expect(getHighVariant('claude-opus-4-5-20251101')).toBe('claude-opus-4-5-20251101-high');
            });
            ...
            it('should return high variant for claude-3-opus', () => {
                expect(getHighVariant('claude-3-opus')).toBe('claude-opus-4-5-20251101-high');
            });
