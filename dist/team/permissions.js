...
function inferPermissionProfile(workerName) {
    ...
    if (normalized.includes('product-cycle-controller'))
        return 'product-cycle';
    if (normalized.includes('product-experience-gate') || normalized.includes('experience-gate'))
        return 'product-experience';
    if (normalized.includes('technology-strategist'))
        return 'technology-strategist';
    if (normalized.includes('priority-engine'))
        return 'product-portfolio';
    if (normalized.includes('product-ecosystem-architect'))
