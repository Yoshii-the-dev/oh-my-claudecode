...
const EXPECTED_DEFAULTS = {
    ...
    'brand-architect': { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'brandArchitect' },
    'brand-steward': { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'brandSteward' },
    'campaign-composer': { model: CLAUDE_FAMILY_DEFAULTS.SONNET, agent: 'campaignComposer' },
    'competitor-scout': { model: CLAUDE_FAMILY_DEFAULTS.SONNET, agent: 'competitorScout' },
    'creative-director': { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'creativeDirector' },
    'domain-expert-reviewer': { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'domainExpertReviewer' },
    ideate: { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'ideate' },
    ...
    'product-cycle-controller': { model: CLAUDE_FAMILY_DEFAULTS.SONNET, agent: 'productCycleController' },
    'priority-engine': { model: CLAUDE_FAMILY_DEFAULTS.SONNET, agent: 'priorityEngine' },
    'product-ecosystem-architect': { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'productEcosystemArchitect' },
