...
describe('model-contract', () => {
    ...
    describe('buildLaunchArgs', () => {
        ...
        it('passes Bedrock model ID through without normalization for claude agent (issue #1695)', () => {
            const args = buildLaunchArgs('claude', { teamName: 't', workerName: 'w', cwd: '/tmp', model: 'us.anthropic.claude-opus-4-7-v1:0' });
            expect(args).toContain('--model');
            expect(args).toContain('us.anthropic.claude-opus-4-7-v1:0');
    ...
    describe('getWorkerEnv', () => {
        ...
        it('propagates allowlisted model selection env vars into worker startup env', () => {
            const env = getWorkerEnv('my-team', 'worker-1', 'claude', {
                ...
                CLAUDE_CODE_BEDROCK_OPUS_MODEL: 'us.anthropic.claude-opus-4-7-v1:0',
            ...
            expect(env.CLAUDE_CODE_BEDROCK_OPUS_MODEL).toBe('us.anthropic.claude-opus-4-7-v1:0');
            ...
            expect(env.ANTHROPIC_DEFAULT_OPUS_MODEL).toBe('claude-opus-4-7-custom');
            ...
            expect(env.OMC_MODEL_HIGH).toBe('claude-opus-4-7-override');
    ...
    describe('resolveClaudeWorkerModel (issue #1695)', () => {
        it('returns undefined when OMC_ROUTING_FORCE_INHERIT=true even if Bedrock model env vars are set', () => {
            ...
            vi.stubEnv('CLAUDE_MODEL', 'us.anthropic.claude-opus-4-7-v1:0');
        ...
        it('returns CLAUDE_MODEL on Bedrock when ANTHROPIC_MODEL is not set', () => {
            ...
            vi.stubEnv('ANTHROPIC_MODEL', '');
            vi.stubEnv('CLAUDE_MODEL', 'us.anthropic.claude-opus-4-7-v1:0');
            expect(resolveClaudeWorkerModel()).toBe('us.anthropic.claude-opus-4-7-v1:0');
            vi.unstubAllEnvs();
        });
