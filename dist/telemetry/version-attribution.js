 ...
 */
export function getOrCreateInstallId(directory) {
 ...
 */
export function getBaseAttribution(directory) {
    return {
 ...
 */
export function getAgentPromptHash(directory, agentType) {
 ...
 */
export function getSkillContentHash(directory, slug) {
 ...
 */
export function getHookVersionHash(directory, hookName) {
 ...
 * @internal
 */
export function resetAttributionCaches() {
...
//# sourceMappingURL=version-attribution.js.map