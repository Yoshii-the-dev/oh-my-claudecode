 ...
 * Never throws.
 */
export async function emit(options, maxFileBytes = DEFAULT_MAX_FILE_BYTES) {
    ...
    try {
        ...
        if (session_id !== undefined)
            envelopeContext['session_id'] = session_id;
        if (run_id !== undefined)
            envelopeContext['run_id'] = run_id;
        if (agent_id !== undefined)
            envelopeContext['agent_id'] = agent_id;
 ...
 */
export async function flush(_directory) {
 ...
 * @internal
 */
export function getPendingBufferSize() {
