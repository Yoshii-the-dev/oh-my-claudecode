 ...
 */
export function readDelegationAudit(directory) {
 ...
 */
export function readAgentReplay(directory, sessionId) {
 ...
 */
export function listAgentReplaySessions(directory) {
 ...
 */
export function readSessionSnapshot(directory, sessionId) {
 ...
 */
export function readSelfImproveRawData(directory) {
...
//# sourceMappingURL=alias-reader.js.map