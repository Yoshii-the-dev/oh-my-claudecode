 ...
 */
export function getOrCreateSalt(directory) {
    if (saltCache.has(directory))
        return saltCache.get(directory);
 ...
 */
export function hashFilePath(directory, filePath) {
 ...
 */
export function redactPrompt(directory, prompt) {
 ...
 */
export function redactPayload(directory, payload) {
