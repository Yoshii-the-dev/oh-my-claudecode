 ...
 */
import { existsSync, statSync, readdirSync, unlinkSync, mkdirSync, readFileSync, writeFileSync, } from 'node:fs';
 ...
 */
export async function rotateIfNeeded(directory, stream) {
 ...
 * Never throws.
 */
export async function gcArchives(directory) {
