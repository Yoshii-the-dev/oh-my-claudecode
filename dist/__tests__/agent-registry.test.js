...
describe('Agent Registry Validation', () => {
    ...
    test('agent registry contains required named agents and excludes consolidated ones', () => {
        ...
        expect(Object.keys(agents)).toContain('priority-engine');
        expect(Object.keys(agents)).toContain('product-ecosystem-architect');
    ...
    test('resolves agent models from env-based tier defaults', () => {
        ...
        const agents = getAgentDefinitions();
        expect(agents.architect?.model).toBe('us.anthropic.claude-opus-4-7-v1:0');
