...
import { CYCLE_PROJECTION_RELATIVE_PATH, getCycleProjectionPath, readCycleDocument, renderCycleProjection, writeCycleProjection, } from './cycle-document.js';
import { LEARNING_PROJECTION_RELATIVE_PATH, getLearningProjectionPath, readLearningDocument, renderLearningProjection, writeLearningProjection, } from './learning-document.js';
import { PORTFOLIO_LEDGER_RELATIVE_PATH, PORTFOLIO_PROJECTION_RELATIVE_PATH, readPortfolioLedger, renderPortfolioProjection, validatePortfolioLedger, writePortfolioProjection, } from './portfolio-ledger.js';
import { migrateRuntimeQaConfig, RUNTIME_QA_CONFIG_RELATIVE_PATH, readRuntimeQaConfigRaw, shouldRunRuntimeQa, } from '../runtime-qa/runner.js';
import { setupRuntimeQaPrerequisites } from '../runtime-qa/setup.js';
import { diagnoseRuntimeQa } from '../runtime-qa/diagnostics.js';
export function repairProductCycle(root = process.cwd(), options = {}) {
...
function repairCycleProjection(root, safe) {
...
function repairLearningProjection(root, safe) {
...
function repairPortfolioProjection(root, safe) {
...
function inspectRuntimeQaRepair(root) {
...
function projectionMatches(path, expected) {
    if (!existsSync(path))
        return false;
...
//# sourceMappingURL=cycle-repair.js.map