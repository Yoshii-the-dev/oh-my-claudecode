...
export type FeatureGenerationSourceKind = 'vision' | 'research' | 'competitors' | 'meaning' | 'ecosystem' | 'capability-map' | 'capability-graph' | 'scenario-coverage' | 'regression' | 'totality' | 'learning' | 'portfolio';
