...
export type FeatureGenerationSourceKind = 'vision' | 'research' | 'competitors' | 'meaning' | 'ecosystem' | 'capability-map' | 'capability-graph' | 'scenario-generator' | 'scenario-coverage' | 'regression' | 'totality' | 'learning' | 'portfolio';
