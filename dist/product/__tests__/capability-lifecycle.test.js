...
function totalityFixture(capabilities, options = {}) {
    return {
        schema_version: 1,
...
function scenarioCoverageFixture(scenarios) {
    return {
        schema_version: 1,
        generated_at: '2026-04-25T00:00:00.000Z',
        root: '/tmp/test',
...
function regressionFixture(debts) {
    return {
        schema_version: 1,
        generated_at: '2026-04-25T00:00:00.000Z',
        root: '/tmp/test',
...
//# sourceMappingURL=capability-lifecycle.test.js.map