...
import { diagnoseRuntimeQa, type RuntimeQaDoctorReport } from '../../runtime-qa/diagnostics.js';
...
export async function runtimeQaDoctorCommand(
  root: string | undefined,
  options: RuntimeQaDoctorCommandOptions,
...
function renderRuntimeQaDoctorReport(report: RuntimeQaDoctorReport): string {
  const lines = [
