...
export async function productRegressionAuditCommand(
  root: string | undefined,
  options: ProductRegressionCommandOptions,
...
function renderProductRegressionSummary(
  report: ProductRegressionReport,
  written: ReturnType<typeof writeProductRegressionAudit> | undefined,
): string {
...
function formatStatus(status: ProductRegressionReport['status']): string {
