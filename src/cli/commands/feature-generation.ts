...
import {
  planFeatureGeneration,
  renderFeatureGenerationPlan,
  writeFeatureGenerationPlan,
  type FeatureGenerationPlan,
} from '../../product/feature-generation.js';
...
export async function featureGenerationAuditCommand(
  root: string | undefined,
  options: FeatureGenerationCommandOptions,
...
function renderAudit(
  ...
  written: ReturnType<typeof writeFeatureGenerationPlan> | undefined,
): string {
  const lines = [
...
function statusColor(status: FeatureGenerationPlan['status']): string {
