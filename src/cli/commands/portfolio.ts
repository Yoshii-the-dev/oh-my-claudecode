...
export async function portfolioProjectCommand(
  root: string | undefined,
  options: PortfolioCommandOptions,
  logger: LoggerLike = console,
): Promise<number> {
...
export async function portfolioMigrateCommand(
  root: string | undefined,
  options: PortfolioCommandOptions,
  logger: LoggerLike = console,
): Promise<number> {
...
function renderMigrationReport(report: PortfolioMigrationReport): string {
  const lines = [
