...
function cycleArtifact(stage: string): string {
...
function writePriorityArtifacts(root: string): void {
...
function writeDiscoveryArtifacts(root: string): void {
...
function portfolioLedgerArtifact(): string {
