...
function incompleteCycleMarkdown(cycleId: string, goal: string, buildRoute: string, stage: string): string {
...
function learningMarkdown(cycleId: string, recommendation: string): string {
