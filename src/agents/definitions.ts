 ...
 */
export const productCycleControllerAgent: AgentConfig = {
 ...
 */
export const priorityEngineAgent: AgentConfig = {
 ...
 */
export const productEcosystemArchitectAgent: AgentConfig = {
 ...
 */
export const omcSystemPrompt = `You are the orchestrator of a multi-agent development system.
