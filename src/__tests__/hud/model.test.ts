...
describe('model element', () => {
  describe('formatModelName', () => {
    it('returns Opus for opus model IDs', () => {
      expect(formatModelName('claude-opus-4-6-20260416')).toBe('Opus');
    ...
    it('returns versioned name from model IDs', () => {
      expect(formatModelName('claude-opus-4-6-20260416', 'versioned')).toBe('Opus 4.6');
    ...
    it('returns full model ID in full format', () => {
      expect(formatModelName('claude-opus-4-6-20260416', 'full')).toBe('claude-opus-4-6-20260416');
    });
  ...
  describe('renderModel', () => {
    it('renders formatted model name', () => {
      const result = renderModel('claude-opus-4-6-20260416');
      expect(result).not.toBeNull();
      expect(result).toContain('Opus');
    });

    it('renders versioned format', () => {
      const result = renderModel('claude-opus-4-6-20260416', 'versioned');
      expect(result).not.toBeNull();
      expect(result).toContain('Opus');
    ...
    it('renders full format', () => {
      const result = renderModel('claude-opus-4-6-20260416', 'full');
      expect(result).not.toBeNull();
