...
const ROLE_PERMISSION_PROFILES: Readonly<Record<PermissionRoleProfile, Omit<WorkerPermissions, 'workerName'>>> = {
  orchestrator: {
...
function inferPermissionProfile(workerName: string): PermissionRoleProfile {
...
export function getRoleScopedPermissions(workerName: string): WorkerPermissions {
