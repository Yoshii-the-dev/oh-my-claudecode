...
- Every plan MUST be accompanied by a `.output.json` sidecar per `docs/schemas/agent-output.schema.json`. Legacy `<handoff>` XML tags and YAML Handoff Envelope v2 blocks are deprecated.
